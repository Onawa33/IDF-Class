...
int main(void)
{
	int arrayOfInts[] = {5, -6, 78, 22, -96, 144, 1, 0}; //randomly chosen numbers to sort
    int numOfElements = 8; //to tell the function bubble sort how many elements are in the array
    ...
    {
        bubble_sort( arrayOfInts, numOfElements, (*compare_function[j])); //passes address of array of functions
