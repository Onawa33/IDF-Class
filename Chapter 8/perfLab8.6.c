...
//15Feb2019
//Recursion lab8.6.c
//Purpose: To understand the concept of recursion
...
unsigned long shadow_sequence_number(int placeNumber);//declares function that returns placeNumber
 ...
 *
 * RETURNS:	   The value of the "Shadow Sequence" number at position "placeNumber" [see: S(placeNumber)].
